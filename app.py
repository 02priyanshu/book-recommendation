...
try:
    ...
    # Handle the error gracefully, perhaps by displaying a user-friendly message on the webpage

import random

# Sample list of books (replace with your actual data)
all_books = [
    {"title": "Book 1", "author": "Author 1", "image_url": "url1"},
    {"title": "Book 2", "author": "Author 2", "image_url": "url2"},
    {"title": "Book 3", "author": "Author 3", "image_url": "url3"},
    {"title": "Book 3", "author": "Author 3", "image_url": "url3"},
    {"title": "Book 3", "author": "Author 3", "image_url": "url3"},
    {"title": "Book 1", "author": "Author 1", "image_url": "url1"},
    {"title": "Book 2", "author": "Author 2", "image_url": "url2"},
